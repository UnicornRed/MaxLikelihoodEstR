...
```{r}
plot(x = seq(start, finish, step), y = m_diffinter, type = "h", ylim = c(0, max(m_diffinter)))
lines(x = seq(start, finish, step), y = 35 / sqrt(seq(start, finish, step)))
plot(x = seq(start, finish, step), y = sd_diffinter, type = "h", ylim = c(0, max(sd_diffinter)))
lines(x = seq(start, finish, step), y = 42 / sqrt(seq(start, finish, step)))
```
